(function() {
  ...
  describe('analyzeWord', function() {
    ...
    it('analyzes longer words', function() {
      let word = 'maximum';
      expect(analyzeWord(word)).toEqual({word: word, numberOfVowels: 3, numberOfLetters: 7})
      word = 'supercalifragilisticexpialidocious'
      expect(analyzeWord(word)).toEqual({word: word, numberOfVowels: 16, numberOfLetters: 34})
    });
  });
