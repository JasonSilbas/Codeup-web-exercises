...
//var "It's raining" = "true"
   // if (It's raining)
       // alert ("It's raining")

//TODO Together: Write an if statement that alerts the user
// whether or not they have enough money to buy a new item.
...
if (numberOfLives == 0){
    alert ("game over");
        ...
        alert("next level!") alert("you are still alive")
...
function SnowExistence(currentweather){
    ...
    weather = "sunny";
console.log(snowExestence(weather));
...
if (overThirteen){
    alert ("you may proceed");
        ...
        alert ("sorry, youre not thirteen")
    }
}
...
if (driverAge < 15){
    ...
    if (driverAge === 15){
        return ("you are eligible for a learners permit")
                ...
                if (hasPermit)
                    return "youre eligible for a license"
            } else {
